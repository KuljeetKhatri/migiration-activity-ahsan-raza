...
public class LkpSegment implements Serializable {
	...
	public TblChargesConfig addTblChargesConfig(TblChargesConfig tblChargesConfig) {
		...
		tblChargesConfig.setLkpSegment(this);
	...
	public TblChargesConfig removeTblChargesConfig(TblChargesConfig tblChargesConfig) {
		...
		tblChargesConfig.setLkpSegment(null);
	...
	public TblChargesConfigRule addTblChargesConfigRule(TblChargesConfigRule tblChargesConfigRule) {
		getTblChargesConfigRules().add(tblChargesConfigRule);
		tblChargesConfigRule.setLkpSegment(this);

		return tblChargesConfigRule;
	}

	public TblChargesConfigRule removeTblChargesConfigRule(TblChargesConfigRule tblChargesConfigRule) {
		getTblChargesConfigRules().remove(tblChargesConfigRule);
		tblChargesConfigRule.setLkpSegment(null);
	...
	public TblChargesShare addTblChargesShare(TblChargesShare tblChargesShare) {
		...
		tblChargesShare.setLkpSegment(this);
	...
	public TblChargesShare removeTblChargesShare(TblChargesShare tblChargesShare) {
		...
		tblChargesShare.setLkpSegment(null);
	...
	public TblChargesShareRule addTblChargesShareRule(TblChargesShareRule tblChargesShareRule) {
		getTblChargesShareRules().add(tblChargesShareRule);
		tblChargesShareRule.setLkpSegment(this);

		return tblChargesShareRule;
	}

	public TblChargesShareRule removeTblChargesShareRule(TblChargesShareRule tblChargesShareRule) {
		getTblChargesShareRules().remove(tblChargesShareRule);
		tblChargesShareRule.setLkpSegment(null);
	...
	public TblCustomer addTblCustomer(TblCustomer tblCustomer) {
		...
		tblCustomer.setLkpSegment(this);
	...
	public TblCustomer removeTblCustomer(TblCustomer tblCustomer) {
		...
		tblCustomer.setLkpSegment(null);
	...
	public TblExcludeLimit addTblExcludeLimit(TblExcludeLimit tblExcludeLimit) {
		getTblExcludeLimits().add(tblExcludeLimit);
		tblExcludeLimit.setLkpSegment(this);

		return tblExcludeLimit;
	}

	public TblExcludeLimit removeTblExcludeLimit(TblExcludeLimit tblExcludeLimit) {
		getTblExcludeLimits().remove(tblExcludeLimit);
		tblExcludeLimit.setLkpSegment(null);
	...
	public TblOperatingHoursRule addTblOperatingHoursRule(TblOperatingHoursRule tblOperatingHoursRule) {
		getTblOperatingHoursRules().add(tblOperatingHoursRule);
		tblOperatingHoursRule.setLkpSegment(this);

		return tblOperatingHoursRule;
	}

	public TblOperatingHoursRule removeTblOperatingHoursRule(TblOperatingHoursRule tblOperatingHoursRule) {
		getTblOperatingHoursRules().remove(tblOperatingHoursRule);
		tblOperatingHoursRule.setLkpSegment(null);
	...
	public TblPricingProfile addTblPricingProfile(TblPricingProfile tblPricingProfile) {
		...
		tblPricingProfile.setLkpSegment(this);
	...
	public TblPricingProfile removeTblPricingProfile(TblPricingProfile tblPricingProfile) {
		...
		tblPricingProfile.setLkpSegment(null);
	...
	public TblThresholdCharge addTblThresholdCharge(TblThresholdCharge tblThresholdCharge) {
		...
		tblThresholdCharge.setLkpSegment(this);
	...
	public TblThresholdCharge removeTblThresholdCharge(TblThresholdCharge tblThresholdCharge) {
		...
		tblThresholdCharge.setLkpSegment(null);
	...
	public TblThresholdChargesRule addTblThresholdChargesRule(TblThresholdChargesRule tblThresholdChargesRule) {
		getTblThresholdChargesRules().add(tblThresholdChargesRule);
		tblThresholdChargesRule.setLkpSegment(this);

		return tblThresholdChargesRule;
	}

	public TblThresholdChargesRule removeTblThresholdChargesRule(TblThresholdChargesRule tblThresholdChargesRule) {
		getTblThresholdChargesRules().remove(tblThresholdChargesRule);
		tblThresholdChargesRule.setLkpSegment(null);
	...
	public TblTransLimitConfig addTblTransLimitConfig(TblTransLimitConfig tblTransLimitConfig) {
		getTblTransLimitConfigs().add(tblTransLimitConfig);
		tblTransLimitConfig.setLkpSegment(this);

		return tblTransLimitConfig;
	}

	public TblTransLimitConfig removeTblTransLimitConfig(TblTransLimitConfig tblTransLimitConfig) {
		getTblTransLimitConfigs().remove(tblTransLimitConfig);
		tblTransLimitConfig.setLkpSegment(null);
	...
	public TblTransPatternHead addTblTransPatternHead(TblTransPatternHead tblTransPatternHead) {
		getTblTransPatternHeads().add(tblTransPatternHead);
		tblTransPatternHead.setLkpSegment(this);

		return tblTransPatternHead;
	}

	public TblTransPatternHead removeTblTransPatternHead(TblTransPatternHead tblTransPatternHead) {
		getTblTransPatternHeads().remove(tblTransPatternHead);
		tblTransPatternHead.setLkpSegment(null);
